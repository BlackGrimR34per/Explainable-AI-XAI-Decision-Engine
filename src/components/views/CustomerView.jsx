...
import TransparentReveal, { StatusBasedReveal } from '../shared/TransparentReveal';
...
export default function CustomerView({ application, whatIfValues, onWhatIfChange }) {
  ...
  return (
    <div className="space-y-6">
      {/* Status Banner with Transparency Reveal */}
      <StatusBasedReveal
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* Why This Decision - with transparency reveal */}
        <TransparentReveal delay={0.3} className="rounded-2xl">
          <Card
        ...
        {/* What Could Help - with transparency reveal */}
        <TransparentReveal delay={0.4} className="rounded-2xl">
          <Card
      ...
      {/* Interactive What-If Simulator - with transparency reveal */}
      {inputs && (
        <TransparentReveal delay={0.5} className="rounded-2xl">
          <Card
      ...
      {/* Model Transparency - with transparency reveal */}
      <TransparentReveal delay={0.6} className="rounded-2xl">
        <Card
      ...
      {/* Your Rights - with transparency reveal */}
      <TransparentReveal delay={0.7} className="rounded-2xl">
        <Card
          title="Your Rights"
